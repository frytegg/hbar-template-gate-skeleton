...
- Deploy scripts live in `packages/hardhat/deploy/` (uses hardhat-deploy)
- Contract ABIs are auto-generated via `yarn hardhat:deploy` - don't manually edit `deployedContracts.ts`
